...
from tradingagents.agents.utils.crypto_data_tools import get_crypto_market_data, get_crypto_indicators, get_news, get_onchain_metrics, get_derivatives_metrics, get_order_flow, get_macro_indicators
...
class GraphSetup:
    ...
    def setup_graph(self, selected_analysts=("market", "sentiment", "news", "onchain", "derivatives", "order_flow", "macro")):
        ...
        tools = {
            "market": ToolNode([get_crypto_market_data, get_crypto_indicators]),
            "sentiment": ToolNode([get_news]),
            "news": ToolNode([get_news, get_macro_indicators]),
            "onchain": ToolNode([get_onchain_metrics]),
            "derivatives": ToolNode([get_derivatives_metrics]),
            "order_flow": ToolNode([get_order_flow]),
